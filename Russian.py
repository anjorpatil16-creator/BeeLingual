...
def next_card():
    ...
    selected_card = current_card["Russian"]
    ...
    window.after(100)
    audio_output = gTTS(text=current_card["Russian"], lang=language)
    audio_output.save("russian_word.mp3")
    playsound.playsound("russian_word.mp3", False)
    os.remove("russian_word.mp3")
...
window = Tk()
window.title("BeeLingual(Vocabulary Building App for Russian)")
...
card_title = canvas.create_text(400, 150, text="Russian", font=("Ariel", 40, "italic"))
